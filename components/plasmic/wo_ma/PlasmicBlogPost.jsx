...
import sty from "./PlasmicBlogPost.module.css"; // plasmic-import: 9UUCJIhfOozi/css
...
function PlasmicBlogPost__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__yFwLc, {
          [sty.freeBoxlong__yFwLcNOeyg]: hasVariant($state, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__pCit)}
              displayHeight={"auto"}
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__kKTtb, {
          [sty.freeBoxlong__kKTtbNOeyg]: hasVariant($state, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
